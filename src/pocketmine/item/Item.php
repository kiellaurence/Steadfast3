...
class Item {
	...
	const BOOK = 387;
	const SLIMEBALL = 388;
	const MINECART_WITH_CHEST = 389;
	const EGG = 390;
	const COMPASS = 391;
	const FISHING_ROD = 392;
	const CLOCK = 393;
	const GLOWSTONE_DUST = 394;
	const DYE = 627;
	const BLACK_DYE = 395; //meta 16
 	const RED_DYE = 396; // meta 1
	const GREEN_DYE = 397; //  meta 2 
	const BROWN_DYE = 398; //meta 17
	const BLUE_DYE = 399; // meta 18
	const PURPLE_DYE = 400; //meta 5
	const CYAN_DYE = 401; //meta 6
	const LIGHT_GRAY_DYE = 402; //meta 7
	const GRAY_DYE = 403; //meta 8
	const PINK_DYE = 404; // meta 9
	const LIME_DYE = 405; // meta 10
	const YELLOW_DYE = 406; // meta 11
	const LIGHT_BLUE_DYE = 407; // meta 12
	const MAGENTA_DYE = 408; // meta 13
	const ORANGE_DYE = 409; // meta 14
	const WHITE_DYE = 410; // meta 19
	const BONE_MEAL = 411; //meta 15
	const COCOA_BEANS = 412; //meta 3
	const INC_SAC = 413; // meta 0
	const LAPIS_LAZULI = 414; // meta 4
	const BONE = 415;
	const SUGAR = 416;
	const CAKE = 417;
	const BED = 418;
	const REDSTONE_REPEATER = 419;
	const COOKIE = 271;
	const SHEARS = 421;
	...
	const ENDER_PERL = 422;
	const BLAZE_ROD = 423;
	const GHAST_TEAR = 424;
	const GOLDEN_NUGGET = 425;
	const NETHER_WART = 294;
	const POTION = 426;
	const GLASS_BOTTLE = 427;
	const SPIDER_EYE = 278;
	const FERMENTED_SPIDER_EYE = 428;
	const BLAZE_POWDER = 429;
	const MAGMA_CREAM = 430;
	const BREWING_STAND = 431;
	const CAULDRON = 432;
	const EYE_OF_ENDER = 433;
	const SPAWN_EGG = 629;
	const BOTTLE_ENCHANTING = 508;
	const WRITABLE_BOOK = 510;
	const WRITTEN_BOOK = 511;
	const EMERALD = 512;
	const ITEM_FRAME = 513;
	const FLOWER_POT = 514;
	const CARROTS = 279;
	const POTATOES = 280;
	...
	const ENCHANTING_BOOK = 521;
	const REDSTONE_COMPARATOR = 522;
	const NETHER_BRICK = 523;
	const NETHER_QUARTZ = 524;
	const MINECART_WITH_TNT = 525;
	const MINECART_WITH_HOPPER = 526;
	const PRISMARINE_SHARD = 565;
	const HOPPER = 527;
	const RAW_RABBIT = 288;
	const COOKED_RABBIT = 289;
	const RABBIT_STEW = 290;
	const RABBIT_FOOT = 528;
	const RABBIT_HIDE = 529;
	const LEAD = 547;
	const NAME_TAG = 548;
	const PRISMARINE_CRYSTAL = 549;
	const END_CRYSTAL = 630;
	const SPRUCE_DOOR = 553;
	const BIRCH_DOOR = 554;
	const JUNGLE_DOOR = 555;
	const ACACIA_DOOR = 556;
	const DARK_OAK_DOOR = 557;
	const CHORUS_FRUIT = 558;
	const DRAGONS_BREATH = 560;
	const SPLASH_POTION = 561;
	const LINGERING_POTION = 562;
	const ELYTRA = 564;
	const SHULKER_SHELL = 566;
	const IRON_NUGGET = 569;
	const BEETROOT = 285;
	...
	const EMPTY_MAP = 515;
	const CARROT_ON_STICK = 517;
	const LEATHER_HORSE_ARMOR = 530;
	const IRON_HORSE_ARMOR = 531;
	const GOLDEN_HORSE_ARMOR = 532;
	const DIAMOND_HORSE_ARMOR = 533;
	const RAW_MUTTON = 550;
	const COOKED_MUTTON = 551;
	const CLOWNFISH = 266;
	const ENCHANTED_GOLDEN_APPLE = 259;
	const GLISTERING_MELON = 434;
	CONST OAK_WOOD_STAIRS = 53;
	const FILLED_MAP = 420;
	const NETHER_STAR = 518;
	const DISC_CHIRP = 537;
	const DISC_MALL = 539;
	const CHEST_MINECART = 389;
	const DISC_STRAD = 542;
	const DISC_WAIT = 545;
	const DISC_CAT = 535;	
	const DISC_13 = 534;
	const DISC_MELLOHI = 540;
	const RECORD_MELLOHI = 540;
	const DISC_11 = 544;
	const FIRE_CHARGE = 509;
	...
	protected static $names = [
		...
		284 => "Pumpkin Pie",
		521 => "Enchanted Book",
		522 => "Redstone Comparator",
		523 => "Nether Bricks",
		524 => "Quartz",
		525 => "Minecart with TNT",
		526 => "Minecart with Hopper",
		565 => "undefined",
		527 => "Hopper",
		288 => "Raw Rabbit",
		289 => "Cooked Rabbit",
		...
		272 => "Melon",
		515 => "Empty Map",
		517 => "Carrot on a Stick",
		530 => "Leather Horse Armor",
		531 => "Iron Horse Armor",
		532 => "Golden Horse Armor",
		533 => "Diamond Horse Armor",
		550 => "Raw Mutton",
		551 => "Cooked Mutton",
		266 => "Tropical Fish",
	...
	public static function init() {
		if (self::$list === null) {
            ...
            self::$list[self::ENDER_PERL] = EnderPearl::class; //NEW ENDER PEARL
	...
	private static function initCreativeItems() {
        ...
        self::addCreativeItem(Item::get(Item::ENDER_PERL, 0));
	}
